...
Today, we cut the strings. You are going to code an **"Expert System"** (a form of Edge AI) so your Pico W can look at its sensor data, combine the information using Boolean Logic, and make its own decisions instantly!
...
| :--- | :--- | :--- |
| **LED** | **GP15** | Use a resistor! Connect short leg to GND. |
...
Your AI is going to need a place to broadcast its thoughts. Let's add a new feed to your Adafruit IO dashboard!
...
3. Make sure you update the engine room with your Adafruit IO Username, Key, and Wi-Fi credentials.
4. **Click Run!** 
5. Watch the Thonny Shell at the bottom. You will see your AI booting up, reading the sensors, and printing its "thoughts" to the screen based on the conditions!
...
* **Test it:** Cover the LDR with your hand to trigger the nightlight AI rule!

### Mission 2: Write a New Rule
Can you add an `elif` statement to make the AI do something silly? 
* **Example:** If it is perfectly bright (`light_level > 80`) and no one is moving (`motion_detected == False`), make the AI output: `"I am bored! Waiting for humans..."`
